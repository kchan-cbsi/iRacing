...
function arrayToXml($array, $rootElement = null, $xml = null, $driverNbr = null, $carClass=null, $crazy=false) {
    ...
    $liveries = [
        ...
        "LMDH" => [
            "Porsche 963 #5 (IMSA 2024)",
            "Porsche 963 #6 (IMSA 2024)",
            "Porsche 963 #7 (IMSA 2024)",
            "Porsche 963 #85 (IMSA 2024)",
            "BMW M Hybrid V8 #24 (IMSA 2024)",
            "BMW M Hybrid V8 #25 (IMSA 2024)",
            "BMW M Hybrid V8 #42",
            "BMW M Hybrid V8 #43",
            "Cadillac V-Series.R #01 (IMSA 2024)",
            "Cadillac V-Series.R #5",
            "Cadillac V-Series.R #31 (IMSA 2024)",
            "Cadillac V-Series.R #9",
            "Alpine A424 #36",
            "Alpine A424 #37",
            "Alpine A424 #38",
            "Alpine A424 #39",
            "Lamborghini SC63 #63 (IMSA 2024)",
            "Lamborghini SC63 #64",
            "Lamborghini SC63 #46",
            "Lamborghini SC63 #47",
        ],
        ...
        "LMP2_Gen2" => [
            ...
            "Ligier JS P217 #82",
            "Ligier JS P217 #88",
            "Oreca 07 #2 (IMSA 2024)",
            "Oreca 07 #04 (IMSA 2024)",
            "Oreca 07 #8 (IMSA 2024)",
            "Oreca 07 #11 (IMSA 2024)",
            "Oreca 07 #18 (IMSA 2024)",
            "Oreca 07 #20",
            "Oreca 07 #22",
            "Oreca 07 #52",
            "Oreca 07 #74",
        ...
        "GT1-2005" => [
            "Aston Martin DBR9 #57",
            "Aston Martin DBR9 #58",
            "Aston Martin DBR9 #59",
            "Aston Martin DBR9 #60",
            "Aston Martin DBR9 #62",
            "Aston Martin DBR9 #64",
            "Chevrolet Corvette C5-R #2",
            "Chevrolet Corvette C5-R #5",
            "Chevrolet Corvette C5-R #7",
            "Chevrolet Corvette C5-R #50",
            "Chevrolet Corvette C5-R #63",
            "Chevrolet Corvette C5-R #70",
            "Chevrolet Corvette C5-R #71",
            "Chevrolet Corvette C5-R #73",
            "Dodge Viper GTS-R #3",
            "Dodge Viper GTS-R #9",
            "Dodge Viper GTS-R #12",
            "Dodge Viper GTS-R #32",
            "Dodge Viper GTS-R #36",
            "Dodge Viper GTS-R #40",
            "Maserati MC12 GT1 #1",
            "Maserati MC12 GT1 #33",
            "Maserati MC12 GT1 #61",
            "Maserati MC12 GT1 #66",
            "Maserati MC12 GT1 #72",
            "Maserati MC12 GT1 #86",
            "Milano GT55 #4",
            "Milano GT55 #6",
            "Milano GT55 #11",
            "Milano GT55 #13",
        ...
        "GT1" => [
            ...
            "McLaren F1 GTR #14",
            "McLaren F1 GTR #15",
            "Mercedes-Benz CLK LM #35",
            "Mercedes-Benz CLK LM #36",
            "Mercedes-Benz CLK LM #40",
            "Mercedes-Benz CLK LM #47",
            "Mercedes-Benz CLK LM #53",
            "Mercedes-Benz CLK LM #57",
            "Mercedes-Benz CLK LM #62",
            "Mercedes-Benz CLK LM #66",
            "Mercedes-Benz CLK LM #72",
            "Mercedes-Benz CLK LM #84",
            "Nissan R390 GT1 #27",
            "Nissan R390 GT1 #28",
            "Nissan R390 GT1 #29",
            "Nissan R390 GT1 #30",
            ...
            "Nissan R390 GT1 #38",
            "Nissan R390 GT1 #39",
            "Panoz Experante GTR-1 #18",
            "Panoz Experante GTR-1 #19",
            "Panoz Experante GTR-1 #20",
            "Panoz Experante GTR-1 #21",
            "Panoz Experante GTR-1 #22",
            "Panoz Experante GTR-1 #23",
            "Panoz Experante GTR-1 #24",
            "Panoz Experante GTR-1 #42",
            "Porsche 911 GT1-98 #25",
            "Porsche 911 GT1-98 #26",
            "Porsche 911 GT1-98 #85",
            "Porsche 911 GT1-98 #00",
            "Porsche 911 GT1-98 #5",
            "Porsche 911 GT1-98 #6",
            "Porsche 911 GT1-98 #8",
            "Porsche 911 GT1-98 #10",
            "Porsche 911 GT1-98 #45",
            "Porsche 911 GT1-98 #77",
        ]
    ];
...
function buildArr($crazy = false, $driverCount = 24) {
    ...
    foreach($names as $i=>$name) {
        ...
        $temp = [
            ...
            "stamina"                      => ($crazy === false) ? getRand(500, 1000) : 0.01,
